...
can_park = cv2.resize(
    cv2.imread("C:/github_repository/assets/Kjara/signs/can_park.jpg", cv2.IMREAD_UNCHANGED),
    (125, 125),  #širina, višina v pikslih 
    interpolation=cv2.INTER_AREA
)
family_car = cv2.resize(
    cv2.imread("C:/github_repository/assets/Kjara/signs/family_car.jpg", cv2.IMREAD_UNCHANGED),
    (125, 125),  #širina, višina v pikslih 
    interpolation=cv2.INTER_AREA
)
electric_car = cv2.resize(
    cv2.imread("C:/github_repository/assets/Kjara/signs/electric_car.jpg", cv2.IMREAD_UNCHANGED),
    (125, 125),  #širina, višina v pikslih
    interpolation=cv2.INTER_AREA
)
car= cv2.resize(
    cv2.imread("C:/github_repository/assets/Kjara/signs/car.webp", cv2.IMREAD_UNCHANGED),
    (80, 80),  #širina, višina v pikslih
    interpolation=cv2.INTER_AREA
)
handicap_parking= cv2.resize(
    cv2.imread("C:/github_repository/assets/Kjara/signs/handicap.png", cv2.IMREAD_UNCHANGED),
    (80, 80),  #širina, višina v pikslih
    interpolation=cv2.INTER_AREA
)
